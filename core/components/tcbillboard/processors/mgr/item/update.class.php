...
class tcBillboardItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('tcbillboard_item_err_ns');
        }
...
return 'tcBillboardItemUpdateProcessor';
