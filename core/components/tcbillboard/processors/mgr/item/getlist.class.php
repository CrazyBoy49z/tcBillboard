...
class tcBillboardItemGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareRow(xPDOObject $object)
    {
        ...
        $array['actions'][] = array(
            'cls' => '',
            'icon' => 'icon icon-edit',
            'title' => $this->modx->lexicon('tcbillboard_item_update'),
        ...
        $array['actions'][] = array(
            ...
            'title' => $this->modx->lexicon('tcbillboard_item_remove'),
            'multiple' => $this->modx->lexicon('tcbillboard_items_remove'),
            'action' => 'removeItem',
            'button' => true,
            'menu' => true,
        );
...
return 'tcBillboardItemGetListProcessor';