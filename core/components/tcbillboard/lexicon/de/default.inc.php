...
$_lang['tcbillboard_num_invoice'] = 'Rechnungsnummer';
$_lang['tcbillboard_sum_order'] = 'Betrag';
$_lang['tcbillboard_bank'] = 'Bitte überweisen Sie den Betrag unter Angabe der Rechnungsnummer innerhalb der nächsten 15 Tagen auf folgendes Konto';
$_lang['tcbillboard_bank_success'] = "Vielen Dank für Ihre Bestellung.<br />Ihre Anzeige wird im angegebenen Zeitraum ausgestellt.<br />Die Rechnung wurde an Ihre E-Mail-Adresse gesendet.";
$_lang['tcbillboard_open'] = 'Anzeige anschauen';
...
$_lang['tcbillboard_front_duration_of_action'] = 'Wann läuft Ihre Aktion';
$_lang['tcbillboard_front_with'] = 'von';
$_lang['tcbillboard_front_by'] = 'bis';
$_lang['tcbillboard_front_promotion_displayed'] = 'Wann muss Ihre Werbung ausgestellt werden';
...
$_lang['tcbillboard_front_price_day'] = 'Preis pro Tag';
$_lang['tcbillboard_front_price_grace_period'] = 'Preis für ermäßigten Zeitraum';
$_lang['tcbillboard_front_grace_day'] = 'Gesamtzahl der Preisermäßigten Tagen';
$_lang['tcbillboard_front_just_day'] = 'Gesamtzahl der gebuchten Tagen';
$_lang['tcbillboard_front_amount_grace_period'] = 'Gesamtbetrag für Preisermäßigten Zeitraum';
$_lang['tcbillboard_front_total'] = 'Gesamtbetrag';
...
$_lang['tcbillboard_err_unpub_pub'] = '';
$_lang['tcbillboard_err_endstock_end'] = '';
$_lang['tcbillboard_err_graceperiod_start'] = '';
...
$_lang['tcbillboard_err_payment_template'] = 'tcBillboard. В системной настройке tcbillboard_payment_template 
    неуказан ID шаблона для информации об оплате. ';