...
$tcBillboard = $modx->getService('tcbillboard', 'tcBillboardTickets', $modx->getOption('tcbillboard_core_path', null,
        $modx->getOption('core_path') . 'components/tcbillboard/') . 'model/tcbillboard/', $properties
);
if ($modx->error->hasError() || !($tcBillboard instanceof tcBillboardTickets)) {
    die('Error');
}
