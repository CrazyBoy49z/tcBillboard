...
$sources = array(
    ...
    'source_tickets_assets' => array(
        'components/tickets/ticketsaction.php',
        'components/tickets/js/web/customfiles.js',
        'components/tickets/js/web/customdefault.js',
    ),
);
//unset($root);
...
$modx->log(modX::LOG_LEVEL_INFO,'Adding file resolvers to Tickets...');
foreach($sources['source_tickets_assets'] as $file) {
    $dir = dirname($file) . '/';

    $tmp = $vehicle->resolve('file',array(
