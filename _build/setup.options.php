...
//    switch ($modx->getOption('manager_language')) {
//        case 'ru':
//            $output = 'Этот компонент требует <b>Tickets</b>.<br/>Он будет автоматически скачан и установлен.';
//            break;
//        default:
//            $output = 'This component requires <b>Tickets</b>.<br/><br/>It will be downloaded and installed automatically.';
//    }
//}
