...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'tcBillboard Files',
                'description' => 'Default media source for files of tcBillboard',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => $assets . '/images/tcbillboard/',
                    ),
                    'baseUrl' => array(
                        'name' => 'baseUrl',
                    ...
                    'thumbnails' => array(
                        ...
                        'value' => '{"thumb":{"w":170,"h":170,"q":90,"zc":"1","bg":"000000"}}',
                    ),
            ...
            $source->save();
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'tcbillboard_source_default'))) {
            ...
            @mkdir(MODX_ASSETS_PATH . 'images/tcbillboard/');
            break;
